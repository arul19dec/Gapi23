...
public class Reporting extends TestListenerAdapter  {
	...
	public void onTestStart(ITestResult tr) {
		...
		//logger.log(Status.PASS, MarkupHelper.createLabel(tr.getName(), ExtentColor.GREEN)); 																						// information to the report
																																													// highlighted
	}
	...
	public void onTestFailure(ITestResult tr) {
       ...
       // logger.log(Status.FAIL, MarkupHelper.createLabel(tr.getThrowable()+ "Test Failed", ExtentColor.RED));																			// to the report with GREEN																				// color highlighted   
